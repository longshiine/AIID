...
const KakaoMap = (props) => {
  useEffect(() => {
    ...
    script.async = true;
    script.src =
      "https://dapi.kakao.com/v2/maps/sdk.js?appkey=5c8b46c9fb95f0c357280a31672c2ffe&autoload=false&libraries=services,clusterer";
    ...
    script.onload = () => {
      kakao.maps.load(() => {
        ...
        placesSearchCB(props.data, kakao.maps.services.Status.OK)
        // 키워드 검색 완료 시 호출되는 콜백
        ...
        function placesSearchCB (data, status, pagination) {
            if (status === kakao.maps.services.Status.OK) {
                ...
                data.forEach(element => {
                  ...
                  markers[i] = displayMarker(element);
                  i++
                });
